...
Add-Content -Path $hostsFilePath -Value "`192.168.1.10 ispl-fs.atecphil3.com"
Add-Content -Path $hostsFilePath -Value "`192.168.1.10 ispl-fs.atecphil.com"
Add-Content -Path $hostsFilePath -Value "`192.168.1.21 ispl-fs"
